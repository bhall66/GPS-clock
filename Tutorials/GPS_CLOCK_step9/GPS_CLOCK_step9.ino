/**************************************************************************
       Title:   GPS clock with TFT display  (STEP 9: IMPROVED DISPLAY)
 ...
 Description:   Step 9 of building a GPS-based clock with TFT display.
                This sketch improves the format of the displayed time.
